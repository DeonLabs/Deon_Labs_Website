...
function Card({ number, type }) {
  return (
    <div className="mb-[2%] mt-[5%] flex  max-h-[30vh] w-[80vw] flex-col justify-evenly rounded-xl border border-gray-500 bg-black drop-shadow-xl md:mx-[4%] md:h-[15vh] lg:h-[25vh] lg:w-[20vw]">
